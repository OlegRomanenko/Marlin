...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 30*60, 30*60, 2*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define E5_HYBRID_THRESHOLD      3
  #define E6_HYBRID_THRESHOLD      3
  #define E7_HYBRID_THRESHOLD      3
